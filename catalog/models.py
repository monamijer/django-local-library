...
class Genre(models.Model):
    ...
    name = models.CharField(
            max_length=200,
            unique=True, 
            help_text="Enter a book genre (e.g. a Science Fiction, French Poetry, etc.)"
            )
    def __str__(self):
...
class Book(models.Model):
    ...
    # Author as a string rather than an object because it hasn't been declared yet in file
